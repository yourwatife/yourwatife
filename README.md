...
Aspiring SOC Analyst | Linux & Windows Security • Log Analysis • Incident Investigation • SIEM
...
I am building practical, hands-on experience in cybersecurity through SOC labs, security projects, and real-world investigation workflows.

My current focus is Blue Team and SOC operations, where I analyze security logs, investigate authentication activity, identify suspicious behavior, and document findings like a security analyst.

I have hands-on experience with Windows Event Logs, Linux logs, Windows investigations, Linux command-line tools, and basic PowerShell, and I am continuing to build my skills in SIEM and security monitoring.
